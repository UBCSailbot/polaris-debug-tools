...
export function parseKeyValuePayload(payload) {
  const out = {};
...
export function parseCapabilities(payload) {
...
export function isTerminalFrame(parsed) {
  if (!parsed) {
    return false;
  }
...
export function isStreamingEvent(parsed) {
